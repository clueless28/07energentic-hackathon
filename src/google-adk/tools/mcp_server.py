...
get_meters_by_id_tool = FunctionTool(get_meters_by_id)

available_tools = {
    event_tool.name: event_tool,
    post_tool.name: post_tool,
    get_meters_by_id_tool.name: get_meters_by_id_tool,
}
...
async def list_tools() -> list[mcp_types.Tool]:
  ...
  get_meters_by_id_schema = adk_to_mcp_tool_type(get_meters_by_id_tool)
  print(f"MCP Server: Received list_tools request. \n MCP Server: Advertising tool: {mcp_tool_schema_event.name} and {mcp_tool_schema_post}")
  return [mcp_tool_schema_event,mcp_tool_schema_post,get_meters_by_id_schema]
